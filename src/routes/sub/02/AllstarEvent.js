        ...
        <div className="sections">
          <div className="inner">
            ...
            <div className="main_description">
              ...
              <br />
              도서 리스트와 공략 등 자료가 방대한 이벤트이며, 도서
              <span className="blue">데이터를 중복으로</span>
              사용하는 부분이 많은게 특징입니다.
            </div>
            <div className="main_description">
              [json 파일을 활용한 중복 데이터 정리]
              <div className="sub_description">
                올스타전 이벤트는 대상도서 리스트에 있는 데이터를 스와이퍼 영역
                , 팝업 영역, 투표지 영역 총 세개의 부분에 들어가야 하는
                상황이였습니다. 따라서, 도서 리스트를 전체적으로 한 파일(json)에
            ...
            <div className="main_description">
              ...
              <br />
              <br />
              올스타전 이벤트는 방대한 양의 자료가 반복적으로 들어가는 구간이
              많아 하드코딩으로 진행되었을때, 약 3000줄 이상의 마크업이 나오는
              이벤트입니다. 중복되는 데이터를 정리 후 끌어 오는 방식을 사용하면,
              유지보수 및 관리 하는 차원에서 작업자가 보다 빠르고 오차없는
              데이터를 입히는데 수월합니다. 결과적으로 도서 리스트에 제법 많은
              수정사항이 들어왔었는데, 그럴때마다 중복되는 모든 마크업을
              변경하는게 아닌, 리스트 파일 하나만을 수정하면 해결되었던 점에서
              수정사항을 수월하게 작업할수있었던 부분이 가장 메리트였습니다.
            </div>
          </div>
        </div>
      </div>
